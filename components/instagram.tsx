...
const Instagram = () => {
  ...
  return (
    <section id="instagram" className="w-full bg-neutral-900 py-20 md:py-32 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4 tracking-tight text-white">Instagram</h2>
          <p className="text-neutral-400 text-lg max-w-2xl mx-auto text-balance">
            En Instagram publico fotos más espontáneas, procesos, detrás de cámaras y nuevos proyectos. Sígueme para ver
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
          {instagramPosts.map((post) => (
            ...
            >
              <img
                src={`/.jpg?height=300&width=300&query=${encodeURIComponent(post.query)}`}
