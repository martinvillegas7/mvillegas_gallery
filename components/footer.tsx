    ...
    <footer className="w-full bg-neutral-950 border-t border-neutral-800 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Brand */}
          <div>
            <h3 className="text-lg font-bold text-white mb-2">Martín Villegas</h3>
            <p className="text-neutral-400 text-sm">Fotógrafo profesional</p>
          </div>

          {/* Links */}
          <div>
            <h4 className="text-sm font-semibold text-white mb-4 uppercase tracking-wide">Enlaces</h4>
          ...
          {/* Social */}
          <div>
            <h4 className="text-sm font-semibold text-white mb-4 uppercase tracking-wide">Sígueme</h4>
            <a
              href="https://instagram.com/mi_usuario"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <div className="border-t border-neutral-800 pt-8">
          <p className="text-center text-neutral-500 text-sm">© 2025 Martín Villegas. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
